...
int main()
{
    ...
    */
    ...
    /*printf("****suppression d'un %cl%cment %c partir d'une r%cf%crence
    donn%c****\n",130,130,133,130,130,130); printf("Donner un entier : "); scanf("%d",&x);
    p=recherche_reference(L1,x);
    if(p)
    {
        printf("%d existe dans la liste et son r%cf%crence =%x\n",x,130,130,p);
    ...
    /*printf("****suppression d'un %cl%cment avant une r%cf%crence
    donn%c****\n",130,130,130,130,130); printf("Donner un entier : "); scanf("%d",&x);
    p=recherche_reference(L1,x);
    if(p)
    {
        printf("%d existe dans la liste et son r%cf%crence =%x\n",x,130,130,p);
    ...
    /*printf("****suppression d'un %cl%cment apr%cs une r%cf%crence
    donn%c****\n",130,130,130,130,130,130); printf("Donner un entier : "); scanf("%d",&x);
    p=recherche_reference(L1,x);
    if(p)
    {
        printf("%d existe dans la liste et son r%cf%crence =%x\n",x,130,130,p);
